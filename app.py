...
def show_cost_estimator():
    ...
    t_con_without_utility = construction_subtotal - t_utility
    t_preliminary = t_con_without_utility * 0.05 
    t_contingency = t_con_without_utility * 0.03
    ...
    t_insurance = t_con_without_utility * (insurance_pct / 100.0)
    ...
    with tab6:
        ...
        with st.expander("View Detailed Project Cost Table", expanded=True):
            ...
            cost_data = {
                ...
                "Basis": [
                    f"5% x Rp {t_con_without_utility:,.0f}",
